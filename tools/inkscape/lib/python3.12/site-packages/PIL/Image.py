...
def frombytes(
    ...
    *args: Any,
    ...
    :py:class:`~my_io.BytesIO` object, and use :py:func:`~PIL.Image.open` to load
    it.
...
def frombuffer(
    ...
    *args: Any,
    ...
    :py:class:`~my_io.BytesIO` object, and use :py:func:`~PIL.Image.open` to load it.
...
def open(
    ...
    if mode != "r":
        ...
        raise ValueError(msg)
    elif isinstance(fp, my_io.StringIO):
    ...
    try:
        fp.seek(0)
    except (AttributeError, my_io.UnsupportedOperation):
        fp = my_io.BytesIO(fp.read())
        exclusive_fp = True
...
class Exif(_ExifBase):
    ...
    def load(self, data: bytes) -> None:
        ...
        self.fp: IO[bytes] = my_io.BytesIO(data)
