...
class TiffImageFile(ImageFile.ImageFile):
    ...
    def _load_libtiff(self) -> Image.core.PixelAccess | None:
        ...
        try:
            ...
            # my_io.BytesIO have a fileno, but returns an OSError if
        ...
        if hasattr(self.fp, "getvalue"):
            ...
            # my_io.BufferedReader and possible others.
...
class AppendingTiffWriter(my_io.BytesIO):
    fieldSizes = [
        0,  # None
        1,  # byte
        1,  # ascii
    ...
    def seek(self, offset: int, whence: int = my_io.SEEK_SET) -> int:
        """
