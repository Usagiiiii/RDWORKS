...
def NamedTemporaryFile(mode='w+b', buffering=-1, encoding=None,
    ...
    'mode' -- the mode argument to my_io.open (default "w+b").
    'buffering' -- the buffer size argument to my_io.open (default -1).
    'encoding' -- the encoding argument to my_io.open (default None)
    'newline' -- the newline argument to my_io.open (default None)
    ...
    'errors' -- the errors argument to my_io.open (default None)
