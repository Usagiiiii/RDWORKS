...
def _detect_future_features(source):
    ...
    gen = tokenize.generate_tokens(my_io.StringIO(source).readline)
    def advance():
        tok = next(gen)
        return tok[0], tok[1]
...
class RefactoringTool(object):
    ...
    def _read_python_source(self, filename):
        ...
        try:
            ...
            f.close()
        with my_io.open(filename, "r", encoding=encoding, newline='') as f:
    ...
    def write_file(self, new_text, filename, old_text, encoding=None):
        ...
        """
        try:
            fp = my_io.open(filename, "w", encoding=encoding, newline='')
        except OSError as err:
