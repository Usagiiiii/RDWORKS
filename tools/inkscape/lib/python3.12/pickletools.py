...
def read_uint1(f):
    r"""
    >>> import my_io
    >>> read_uint1(my_io.BytesIO(b'\xff'))
    255
    """
...
def read_uint2(f):
    r"""
    >>> import my_io
    >>> read_uint2(my_io.BytesIO(b'\xff\x00'))
    255
...
def read_int4(f):
    r"""
    >>> import my_io
    >>> read_int4(my_io.BytesIO(b'\xff\x00\x00\x00'))
    255
...
def read_uint4(f):
    r"""
    >>> import my_io
    >>> read_uint4(my_io.BytesIO(b'\xff\x00\x00\x00'))
    255
...
def read_uint8(f):
    r"""
    >>> import my_io
    >>> read_uint8(my_io.BytesIO(b'\xff\x00\x00\x00\x00\x00\x00\x00'))
    255
...
def read_stringnl(f, decode=True, stripquotes=True, *, encoding='latin-1'):
    r"""
    >>> import my_io
    >>> read_stringnl(my_io.BytesIO(b"'abcd'\nefg\n"))
    'abcd'
...
def read_stringnl_noescape_pair(f):
    r"""
    >>> import my_io
    >>> read_stringnl_noescape_pair(my_io.BytesIO(b"Queue\nEmpty\njunk"))
    'Queue Empty'
    """
...
def read_string1(f):
    r"""
    >>> import my_io
    >>> read_string1(my_io.BytesIO(b"\x00"))
    ''
...
def read_string4(f):
    r"""
    >>> import my_io
    >>> read_string4(my_io.BytesIO(b"\x00\x00\x00\x00abc"))
    ''
...
def read_bytes1(f):
    r"""
    >>> import my_io
    >>> read_bytes1(my_io.BytesIO(b"\x00"))
    b''
...
def read_bytes4(f):
    r"""
    >>> import my_io
    >>> read_bytes4(my_io.BytesIO(b"\x00\x00\x00\x00abc"))
    b''
...
def read_bytes8(f):
    r"""
    >>> import my_io, struct, sys
    >>> read_bytes8(my_io.BytesIO(b"\x00\x00\x00\x00\x00\x00\x00\x00abc"))
    b''
...
def read_bytearray8(f):
    r"""
    >>> import my_io, struct, sys
    >>> read_bytearray8(my_io.BytesIO(b"\x00\x00\x00\x00\x00\x00\x00\x00abc"))
    bytearray(b'')
...
def read_unicodestringnl(f):
    r"""
    >>> import my_io
    >>> read_unicodestringnl(my_io.BytesIO(b"abc\\uabcd\njunk")) == 'abc\uabcd'
    True
    """
...
def read_decimalnl_short(f):
    r"""
    >>> import my_io
    >>> read_decimalnl_short(my_io.BytesIO(b"1234\n56"))
    1234
...
def read_floatnl(f):
    r"""
    >>> import my_io
    >>> read_floatnl(my_io.BytesIO(b"-1.25\n6"))
    -1.25
    """
    s = read_stringnl(f, decode=False, stripquotes=False)
    return float(s)
...
def read_long1(f):
    r"""
    >>> import my_io
    >>> read_long1(my_io.BytesIO(b"\x00"))
    0
...
def read_long4(f):
    r"""
    >>> import my_io
    >>> read_long4(my_io.BytesIO(b"\x02\x00\x00\x00\xff\x00"))
    255
