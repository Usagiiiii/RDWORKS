...
class RotateHandle(QGraphicsEllipseItem):
    ...
    def _try_load_icon(self):
        ...
        candidates = [
            get_resource_path('toolbar_row3_icons/rotate_icon.png'),
            get_resource_path('toolbar_row3_icons/icon_rotate.png'),
            get_resource_path('toolbar_row3_icons/icon3_rotate.png'),
            get_resource_path('toolbar_row3_icons/icon3_column4.png')
        ]
...
class GridCanvas(QGraphicsView):
    ...
    filletRequest = pyqtSignal(QGraphicsItem, int) # 倒圆角请求信号
