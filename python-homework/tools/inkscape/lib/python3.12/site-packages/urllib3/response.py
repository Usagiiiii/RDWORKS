...
class BaseHTTPResponse(my_io.IOBase):
    ...
    # Compatibility methods for `my_io` module
...
class HTTPResponse(BaseHTTPResponse):
    ...
    class is also compatible with the Python standard library's :mod:`my_io`
    ...
    def read1(
        ...
        in :meth:`my_io.BufferedReader.read1`, but with an additional parameter:
        ``decode_content``.
    ...
    def close(self) -> None:
        ...
        if not self.auto_close:
            my_io.IOBase.close(self)

    @property
    def closed(self) -> bool:
        if not self.auto_close:
            return my_io.IOBase.closed.__get__(self)  # type: ignore[no-any-return]
