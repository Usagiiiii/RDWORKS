    ...
    try:
        ...
        if encoding.lower() == "unicode":
            ...
            with contextlib.ExitStack() as stack:
                if isinstance(file_or_filename, my_io.BufferedIOBase):
                    file = file_or_filename
                elif isinstance(file_or_filename, my_io.RawIOBase):
                    file = my_io.BufferedWriter(file_or_filename)
...
def tostring(element, encoding=None, method=None, *,
    ...
    *element* is an Element instance, *encoding* is an optional output
    ...
    """
    stream = my_io.StringIO() if encoding == 'unicode' else my_io.BytesIO()
...
class _ListDataStream(my_io.BufferedIOBase):
