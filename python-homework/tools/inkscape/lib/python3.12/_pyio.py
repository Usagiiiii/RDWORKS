"""
Python implementation of the my_io module.
"""
...
# defined in my_io.py. We don't use real inheritance though, because we don't want
# to inherit the C implementations.

# Rebind for compatibility
BlockingIOError = BlockingIOError

# Does my_io.IOBase finalizer log the exception if the close() method fails?
...
def open(file, mode="r", buffering=-1, encoding=None, errors=None,
    ...
    * Binary files are buffered in fixed-size chunks; the size of the buffer
      ...
      "block size" and falling back on `my_io.DEFAULT_BUFFER_SIZE`.
...
class BufferedReader(_BufferedIOMixin):
    ...
    # similar to the my_io implementation (which implements the methods for
    # performance reasons).
