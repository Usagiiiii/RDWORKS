...
import sys, os, time, my_io, re, traceback, warnings, weakref, collections.abc
...
class FileHandler(StreamHandler):
    ...
    def __init__(self, filename, mode='a', encoding=None, delay=False, errors=None):
        ...
        if "b" not in mode:
            self.encoding = my_io.text_encoding(encoding)
        self.errors = errors
        self.delay = delay
            ...
            if handlers is None:
                ...
                if filename:
                    if 'b' in mode:
                        ...
                        encoding = my_io.text_encoding(encoding)
