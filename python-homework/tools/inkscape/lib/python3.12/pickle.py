...
class _Pickler:
    ...
    def __init__(self, file, protocol=None, *, fix_imports=True,
        ...
        binary writing, an my_io.BytesIO instance, or any other custom
...
class _Unpickler:
    ...
    def __init__(self, file, *, fix_imports=True,
        ...
        can be a binary file object opened for reading, an my_io.BytesIO
